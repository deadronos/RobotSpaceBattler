...
- Top-left status label (`#status`) updates:
  - “Battle in progress”
  - “Simulation paused”
  - “Victory: … · restart in Ns”
- After victory, the match restarts automatically after ~5 seconds
