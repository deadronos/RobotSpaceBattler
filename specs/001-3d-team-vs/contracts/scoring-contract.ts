import type { WeaponType } from "../../../src/ecs/world";

// Machine-readable mirror of scoring-contract.md.
...
export const MULTIPLIER_ADVANTAGE = 1.25;
export const MULTIPLIER_DISADVANTAGE = 0.85;
