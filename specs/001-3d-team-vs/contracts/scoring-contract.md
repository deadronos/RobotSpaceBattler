# Scoring Contract: Weapon Rock-Paper-Scissors Balance (As Implemented)
...
- Weapon profiles (base damage): `src/simulation/combat/weapons.ts`
- Multiplier matrix: `src/simulation/combat/weapons.ts`
