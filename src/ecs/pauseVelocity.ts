...
export function setPauseVelocity<T extends PauseVelocityComponent>(entity: T, lin?: Vec3, ang?: Vec3) {
...
export function clearPauseVelocity<T extends PauseVelocityComponent>(entity: T) {
  if (entity.pauseVel) {
