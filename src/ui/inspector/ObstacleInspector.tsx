...
export function ObstacleInspector({
  ...
  const setMovement = (next: typeof movement) =>
    apply({ movementPattern: next ?? undefined });
              ...
              onChange={(v) =>
                setMovement({
                  ...
                  pivot: vec3(
                    v,
                    0,
                    movement?.pivot?.z ?? obstacle.position?.z ?? 0,
                  ),
                })
              }
            />
            <NumberInput
              ...
              onChange={(v) =>
                setMovement({
                  ...movement!,
                  pivot: vec3(
                    movement?.pivot?.x ?? obstacle.position?.x ?? 0,
                    0,
                    v,
                  ),
                })
          ...
          >
            ...
            <NumberInput
              ...
              onChange={(v) =>
                apply({
                  hazardEffects: [
                    { kind: "damage", amount: v, perSecond: true },
                  ],
                })
              }
            />
